...
SUPPLEMENT: dict[str, str] = {
    ...
    # ===============================================================
    # FINAL EXPANSION — remaining corpus-frequency gaps (297 words)
    # ===============================================================

    # === MISSING PRONOUNS / DEMONSTRATIVES (all case forms) ===
    "yat-stem": "yat — which / what",
    "yā-rel": "yā — who / which (fem.)",
    "yaḥ-rel": "yaḥ — who / which (masc.)",
    "ya-rel": "ya — who / which (base)",
    "yāni-pl": "yāni — which (neut. pl.)",
    "yāḥ": "yāḥ — who / which (fem. pl.)",
    "yeṣu": "yeṣu — in which (loc. pl.)",
    "yebhyo": "yebhyaḥ — from which (abl. pl.)",
    "yebhyaḥ": "yebhyaḥ — from which (abl. pl.)",
    "paraṃ-pron": "paraṃ — supreme / ultimate",
    "paraḥ": "paraḥ — supreme / other",
    "nā": "na — not [sandhi variant before vowel]",
    "eta-base": "etat — this",
    "ete": "ete — these (masc. nom. pl.)",
    "eṣu": "eṣu — in these (loc. pl.)",
    "asya": "asya — of this / his (gen.)",
    "kaḥ-int": "kaḥ — who? (interrogative)",
    "kā-int": "kā — who? (fem. interrogative)",
    "kāni": "kāni — which? (neut. pl.)",
    "kati-int": "kati — how many?",
    "tebhyaḥ": "tebhyaḥ — for them / from them (dat./abl. pl.)",
    "tebhyo": "tebhyaḥ — for them [sandhi form]",
    "tasmai": "tasmai — for him / to that (dat.)",
    "ubhe": "ubhe — both (dual)",
    "sve-pron": "sve — in one's own (loc.)",

    # === COMMON SANDHI-FUSED FORMS (the #1 remaining gap!) ===
    "nāsti": "na+asti — does not exist",
    "nāsty": "na+asti — does not exist [before vowel: i→y]",
    "nāstyū": "na+asti+ū — does not exist + [vowel sandhi]",
    "yastu": "yaḥ+tu — he who, but",
    "nahi": "na+hi — indeed not / for... not",
    "caiṣā": "ca+eṣā — and this (fem.)",
    "caiṣāṃ": "ca+eṣām — and of these",
    "cocyate": "ca+ucyate — and is said",
    "cādhikam": "ca+adhikam — and more / and excessive",
    "cāmlena": "ca+amlena — and with sour",
    "śiraśca": "śiraḥ+ca — and the head",
    "vṛkṣāśca": "vṛkṣāḥ+ca — and trees",
    "granthiśca": "granthiḥ+ca — and node",
    "tāvadasya": "tāvat+asya — so much of this",
    "cet": "cet — if (conditional particle)",

    # === COMMON VERBS (remaining) ===
    "asti-verb": "asti — is / exists",
    "kupyanti": "kupyanti — they get aggravated",
    "prakupyanti": "prakupyanti — they get aggravated",
    "praśāmyanti": "praśāmyanti — they get pacified",
    "dṛśyante": "dṛśyante — they are seen",
    "dahyate": "dahyate — is burnt / burns",
    "praviśati": "praviśati — enters",
    "sīdati": "sīdati — sinks / weakens",
    "vardhate": "vardhate — increases / grows",
    "bhajate": "bhajate — resorts to / favors",
    "gacchet": "gacchet — should go (optative)",
    "caret": "caret — should move / conduct oneself",
    "śīlayet": "śīlayet — should practice / cultivate",
    "nibodha": "nibodha — understand! / listen! (imperative)",
    "karṣet": "karṣet — should extract / pull",
    "provāca": "provāca — said / spoke (perfect tense)",
    "vyājahāra": "vyājahāra — spoke / declared",
    "upadekṣyate": "upadekṣyate — will be instructed",
    "vakṣyati": "vakṣyati — will say",
    "pravadanti": "pravadanti — they declare",
    "jñeyo": "jñeya — to be known [sandhi form]",
    "prayojyā": "prayojyā — should be applied (fem.)",
    "yojyā": "yojyā — should be applied (fem.)",
    "vicārayan": "vicārayan — deliberating / considering",
    "piban": "piban — drinking (present participle)",
    "śṛtā": "śṛta — boiled / decocted (fem.)",

    # === HEAT / THERMAL TERMS ===
    "ūṣmā": "Ūṣmā — heat / thermal energy",
    "ūṣman": "Ūṣman — heat / thermal energy",
    "ūṣmaṇā": "Ūṣmaṇā — by heat (instrumental)",
    "uṣma": "Uṣma — heat",

    # === DIGESTIVE / ĀHĀRA TERMS ===
    "pācana": "Pācana — digestive / that which promotes digestion",
    "pācanaṃ": "Pācanaṃ — digestive",
    "pācanam": "Pācanam — digestive",
    "apaha": "apaha — removing / alleviating (compound-final: -apaha)",
    "apaham": "apaham — removing [accusative]",
    "apahaḥ": "apahaḥ — removing",
    "jvarāpaha": "jvarāpaha — fever-removing",
    "tṛḍ": "Tṛṣṇā — thirst [compound-internal phonetic form: tṛḍ from tṛṣṇā]",
    "tṛṣ": "Tṛṣ — thirst (root form)",
    "pipāsā": "Pipāsā — thirst / desire to drink",
    "ṛte": "ṛte — without / except / apart from",
    "samyak": "samyak — properly / correctly / thoroughly",
    "jīrṇe": "jīrṇa — digested [locative: when digested]",
    "jīrṇa": "jīrṇa — digested / old",
    "ajīrṇe": "ajīrṇa — indigestion [locative: during indigestion]",

    # === BODY/LIFE COMMON ===
    "bhagavan": "bhagavan — O venerable one! (vocative)",
    "bhiṣak-n": "bhiṣaj — physician",
    "kriyā-n": "kriyā — action / procedure / treatment",
    "kriyāḥ": "kriyāḥ — actions / procedures",
    "vyādhayo": "vyādhayaḥ — diseases (nom. pl.) [sandhi form]",
    "vyādhayaḥ": "vyādhayaḥ — diseases (nom. pl.)",
    "kampa": "Kampa — tremor / trembling",
    "kampaḥ": "Kampaḥ — tremor",
    "galagraha": "Galagraha — throat obstruction / difficulty swallowing",
    "galagrahaḥ": "Galagrahaḥ — throat obstruction",
    "kaṇḍū": "Kaṇḍū — itching / pruritus",
    "kaṇḍūṃ": "Kaṇḍūṃ — itching [accusative]",
    "kaṇḍūḥ": "Kaṇḍūḥ — itching",
    "keśa": "Keśa — hair",
    "keśāḥ": "Keśāḥ — hairs",
    "keśā": "Keśā — hair [compound form]",
    "bala-n": "Bala — strength",
    "bale": "Bala — strength [locative]",
    "balī": "Balī — strong one",
    "balināṃ": "Balināṃ — of the strong ones (gen. pl.)",

    # === TIME / COSMIC ===
    "rātrau": "rātrau — at night (locative)",
    "naktaṃ-time": "naktam — at night",
    "visarga": "Visarga — emission / release (cosmic function); also: the cool season",
    "visargaḥ": "Visargaḥ — emission",
    "visarge": "Visarge — during emission [locative]",
    "ādāna": "Ādāna — absorption (cosmic function); also: the hot season",

    # === PHILOSOPHICAL / TEXTUAL ===
    "veda": "Veda — knowledge / scripture",
    "vedaṃ": "Vedaṃ — knowledge [accusative]",
    "vedo": "Veda — knowledge [sandhi form]",
    "śāstra": "Śāstra — science / scripture / treatise",
    "śāstraṃ": "Śāstraṃ — science / treatise",
    "darśana": "Darśana — vision / examination / philosophy",
    "darśanaṃ": "Darśanaṃ — vision / examination",
    "sādhyu": "sādhu — excellent! / good! / well done!",
    "sādhu": "sādhu — excellent! / good!",
    "saumya": "saumya — O gentle one! (vocative); also: lunar / cool",
    "dayā": "dayā — compassion",
    "kṣamā": "kṣamā — patience / forbearance",
    "pretya": "pretya — after death / in the next world",
    "sukhī": "sukhī — happy person",
    "loka-n": "loka — world / people",
    "loke-loc": "loke — in the world",
    "cetaḥ": "cetaḥ — mind / consciousness",
    "kvacit": "kvacit — somewhere / sometimes",
    "āśu": "āśu — quickly / immediately",
    "śarma-n": "śarma — comfort / happiness",
    "samprakāśita": "samprakāśita — clearly explained / illuminated",
    "samprakāśitaḥ": "samprakāśitaḥ — clearly explained",
    "samprakāśitam": "samprakāśitam — clearly explained",
    "smṛtaḥ-adj": "smṛtaḥ — remembered / considered / declared",
    "kṛtaḥ": "kṛtaḥ — done / made / accomplished",
    "parikīrtita": "parikīrtita — declared / enumerated",
    "parikīrtitaḥ": "parikīrtitaḥ — declared",

    # === DAILY ROUTINE / LIFESTYLE ===
    "śayana": "Śayana — sleeping / bed / reclining",
    "śayanaṃ": "Śayanaṃ — sleeping / bed",
    "snāna": "Snāna — bathing",
    "snānaṃ": "Snānaṃ — bathing",
    "śastra": "Śastra — weapon / surgical instrument",
    "śastraṃ": "Śastraṃ — weapon / surgical instrument",
    "dhūma-n": "Dhūma — smoke / medicated smoke",

    # === MILK / FOOD (remaining) ===
    "paya-n": "Paya — milk",
    "payaḥ-n": "Payaḥ — milk",
    "payo-n": "Payo — milk [sandhi form]",
    "payāṃsi": "Payāṃsi — milks (nom. pl.)",
    "sarpiṣaḥ": "Sarpiṣaḥ — of ghee (gen.)",
    "sarpiḥ-n": "Sarpiḥ — ghee",
    "dadhnā": "dadhnā — with curd/yogurt (instrumental)",
    "māhiṣa": "Māhiṣa — of/from buffalo",
    "māhiṣaṃ": "Māhiṣaṃ — buffalo (product)",
    "manthaḥ": "Manthaḥ — churned drink / mantha preparation",
    "mantha": "Mantha — churned drink / stirred preparation",
    "salilaṃ": "Salilaṃ — water",
    "salila-n": "Salila — water",
    "nāgara": "Nāgara — dry ginger (= śuṇṭhī; Zingiber officinale)",
    "nāgaraṃ": "Nāgaraṃ — dry ginger",
    "lodhra": "Lodhra — Symplocos racemosa",
    "lodhraṃ": "Lodhraṃ — Lodhra",
    "trapuṣa": "Trapuṣa — cucumber (Cucumis sativus)",
    "trapuṣaṃ": "Trapuṣaṃ — cucumber",

    # === CLINICAL (remaining) ===
    "bileśaya": "Bileśaya — animals living in burrows",
    "bileśayānāṃ": "Bileśayānāṃ — of burrow-dwelling animals",
    "catuṣka": "Catuṣka — group of four / tetrad",
    "catuṣkaḥ-n": "Catuṣkaḥ — group of four",
    "sānnipātika": "Sānnipātika — caused by sannipāta (tri-doṣic)",
    "sānnipātikī": "Sānnipātikī — tri-doṣic (fem.)",
    "dāruṇa": "dāruṇa — severe / terrible",
    "dāruṇāḥ": "dāruṇāḥ — severe (pl.)",
    "dāruṇā": "dāruṇā — severe (fem.)",
    "khāni": "khāni — orifices / openings (neut. pl.)",
    "kha": "kha — space / orifice / aperture",
    "raukṣya-n": "Raukṣya — dryness / roughness (symptom)",
    "raukṣyaṃ-n": "Raukṣyaṃ — dryness",
    "piḍakā-n": "Piḍakā — pustule / eruption",
    "piḍakāḥ-n": "Piḍakāḥ — pustules",
    "śarāvikā-n": "Śarāvikā — saucer-shaped (type of piḍakā)",
    "vinatā-n": "Vinatā — depressed / concave (type of piḍakā)",
    "nīlikā": "Nīlikā — bluish discoloration (type of piḍakā)",
    "kuśala": "kuśala — skilled / proficient",
    "kuśalāḥ": "kuśalāḥ — skilled ones",
    "muktvā": "muktvā — having released / except",
    "piṣṭvā": "piṣṭvā — having ground / having crushed",
    "nirvāpaṇa": "Nirvāpaṇa — cooling / quenching",
    "nirvāpaṇaḥ": "Nirvāpaṇaḥ — cooling",
    "yogāḥ": "yogāḥ — formulations / combinations (pl.)",
    "sevyaṃ-adj": "sevyam — to be consumed / to be practiced",
    "pāmā": "Pāmā — eczema / scabies (skin disease)",
    "viṣaṃ-n": "Viṣaṃ — poison",
    "sphuṭana": "Sphuṭana — cracking / splitting",
    "sphuṭanaṃ": "Sphuṭanaṃ — cracking",
    "śama": "Śama — pacification / alleviation",
    "śamaḥ": "Śamaḥ — pacification",

    # === HERBS (remaining corpus-frequency) ===
    "suradāru-herb": "Suradāru — Cedrus deodara (deodar)",
    "haridra-herb": "Haridrā — turmeric",
    "haridre": "Haridrā — turmeric [dual/locative]",
    "pṛśniparṇī": "Pṛśniparṇī — Uraria picta",
    "pṛśniparṇīṃ": "Pṛśniparṇīṃ — Pṛśniparṇī [acc.]",
    "pṛśniparṇyā": "Pṛśniparṇyā — with Pṛśniparṇī [instr.]",
    "jālinī-herb": "Jālinī — (a plant variety)",
    "sarṣapī": "Sarṣapī — mustard preparation (fem.)",
    "kṣāra": "Kṣāra — alkali / caustic preparation",
    "kṣāraḥ": "Kṣāraḥ — alkali",
    "prapauṇḍarīka": "Prapauṇḍarīka — Nelumbo nucifera (lotus variety)",
    "prapauṇḍarīkaṃ": "Prapauṇḍarīkaṃ — Prapauṇḍarīka",

    # === MEASUREMENT / MISC ===
    "ta-base": "ta — that (base of demonstrative)",
    "mūrdhni": "mūrdhni — on the head (locative of mūrdhan)",
    "nṛṇām": "nṛṇām — of men / of people (gen. pl.)",
    "bījāt": "bījāt — from the seed (ablative)",
    "bījāni": "bījāni — seeds (nom. pl.)",
    "śarīriṇām": "śarīriṇām — of embodied beings (gen. pl.)",
    "samīraṇa": "Samīraṇa — stimulation; also = Vāta (wind)",
    "samīraṇam": "Samīraṇam — stimulation",
    "tanu-adj": "tanu — thin / subtle / slender",
    "śuci": "śuci — pure / clean",
    "bhuvi-loc": "bhuvi — on the earth (locative)",
    "vistarasya": "vistarasya — of the detailed (exposition)",
    "sañjñā-n": "Sañjñā — name / consciousness",
    "vāyoḥ": "vāyoḥ — of vāta / of wind (genitive)",


    # ===============================================================
    # 100-ŚLOKA TEST — remaining gaps (87 words)
    # ===============================================================

    # === COMMON VERB FORMS ===
    "yojayet": "yojayet — should apply / should administer (causative optative √yuj)",
    "pālayan": "pālayan — protecting (present participle √pāl)",
    "viśodhayet": "viśodhayet — should purify / should cleanse",
    "pravartayet": "pravartayet — should initiate / should promote",
    "udīrya": "udīrya — having stimulated / having raised (absolutive)",
    "mṛdūkṛtya": "mṛdūkṛtya — having softened (mṛdu + kṛtvā)",
    "jvalayati": "jvalayati — kindles / inflames",
    "jayet": "jayet — should conquer / should overcome (optative √ji)",
    "pīḍyate": "pīḍyate — is afflicted / is pressed (passive √pīḍ)",
    "neṣyate": "neṣyate — will be led / will be described (future passive √nī)",
    "neyo": "neya — to be administered [sandhi form]",
    "prayoktavyo": "prayoktavya — to be employed / to be administered",
    "prayojyaḥ-m": "prayojyaḥ — to be employed (masc. nom.)",
    "vāti": "vāti — blows / is active (of vāta, √vā)",
    "cānurudhyate": "ca+anurudhyate — and follows / and conforms to",
    "nītvā": "nītvā — having led / having taken (absolutive √nī)",

    # === CLINICAL / SYMPTOM TERMS ===
    "jvarī": "Jvarī — one afflicted with fever",
    "parikartini": "parikartinī — cutting / griping (type of pain in abdomen)",
    "halīmaka": "Halīmaka — a type of advanced kāmala (jaundice/chlorosis)",
    "halīmakam": "Halīmakam — Halīmaka",
    "sṛṣṭaviḍ": "sṛṣṭaviṭ — one with normal bowel movements (sṛṣṭa+viṭ)",
    "vibaddha": "vibaddha — obstructed / constipated",
    "vibaddhe": "vibaddha — obstructed [locative]",
    "vibaddhavarchāḥ": "vibaddha+varcas — one with constipated stool",
    "samutkliṣṭe": "samutkliṣṭa — greatly aggravated / severely vitiated [locative]",
    "samudīrṇānāṃ": "samudīrṇānām — of the greatly excited/aggravated (gen. pl.)",
    "pravṛtte": "pravṛtta — commenced / manifested [locative]",
    "śithile": "śithila — loosened / relaxed [locative]",
    "paittike": "paittika — caused by pitta / bilious [locative]",
    "cale": "cala — mobile / displaced [locative]",
    "pāṭava": "Pāṭava — sharpness / keenness / clarity",
    "pāṭavam": "Pāṭavam — sharpness / clarity",
    "sañjāte": "sañjāta — arisen / occurred [locative]",

    # === ADVERBS / PARTICLES / PRONOUNS ===
    "prāyeṇa": "prāyeṇa — mostly / generally",
    "krameṇa": "krameṇa — gradually / in sequence (instrumental of krama)",
    "sati": "sati — being / when there is (locative absolute, present participle √as)",
    "yatnena": "yatnena — with effort / carefully (instrumental of yatna)",
    "tābhiḥ": "tābhiḥ — by those (fem. instrumental pl.)",
    "sutarāṃ": "sutarām — exceedingly / greatly",
    "yāvat": "yāvat — as long as / until",
    "tasmānna": "tasmāt+na — therefore not",

    # === SANDHI-FUSED ===
    "cāgniṃ": "ca+agnim — and the fire (agni acc.)",
    "jānīyādaviśoṣitam": "jānīyāt+aviśoṣitam — one should know [that it is] not dried up",
    "yāvadavāpnuyāt": "yāvat+avāpnuyāt — until one obtains",
    "odanastaiḥ": "odanaḥ+taiḥ — gruel/rice with those (instr.)",
    "kulatthaiśca": "kulatthaiḥ+ca — and with horse gram (instr.)",
    "ṣaṣṭikāśca": "ṣaṣṭikāḥ+ca — and ṣaṣṭika rice",
    "hyalaṃ": "hi+alam — indeed sufficient / indeed capable",
    "balapradam": "balaprada — strength-giving (bala+prada)",

    # === FOODS / PREPARATIONS ===
    "tarpaṇa": "Tarpaṇa — satiating preparation / nourishing therapy",
    "tarpaṇena": "Tarpaṇena — with tarpaṇa (instrumental)",
    "tarpaṇe": "Tarpaṇa — tarpaṇa [locative]",
    "odana": "Odana — cooked rice / gruel",
    "odanaṃ": "Odanaṃ — cooked rice",
    "modaka": "Modaka — sweet ball / medicated sweet preparation",
    "modakaṃ": "Modakaṃ — sweet ball",
    "sarpiṣā": "sarpiṣā — with ghee (instrumental of sarpis)",
    "bhṛṣṭa": "bhṛṣṭa — roasted / fried",
    "bhṛṣṭāṃ": "bhṛṣṭāṃ — roasted (fem. acc.)",
    "sakṣaudra": "sakṣaudra — with honey (sa+kṣaudra)",
    "sakṣaudraṃ": "sakṣaudraṃ — with honey",
    "havis": "Havis — oblation / ghee offering",
    "haviḥ": "Haviḥ — oblation / ghee",
    "prastha": "Prastha — a unit of measure (~768 ml)",
    "prasthaṃ": "Prasthaṃ — one prastha",
    "savālaka": "savālaka — with bālaka (Pavonia odorata)",
    "savālakam": "savālakam — with bālaka",
    "vaudana": "vā+odana — or rice/gruel",
    "vaudanaṃ": "vā+odanaṃ — or rice/gruel",

    # === HERBS (remaining) ===
    "paṭola": "Paṭola — pointed gourd (Trichosanthes dioica)",
    "paṭolaṃ": "Paṭolaṃ — Paṭola",
    "sārivā": "Sārivā — Indian sarsaparilla (Hemidesmus indicus)",
    "kaṇṭakārikā": "Kaṇṭakārikā — Solanum xanthocarpum (yellow-berried nightshade)",
    "guḍūcyā": "guḍūcyā — with guḍūcī (instrumental)",
    "tailvakaṃ": "Tailvaka — preparation made from Symplocos racemosa oil",
    "vṛṣa": "Vṛṣa — Adhatoda vasica (= vāsā)",
    "gāṅgeyī": "Gāṅgeyī — a variety of Durva grass",
    "śṛṅga": "Śṛṅga — horn; also a plant",
    "bera": "Bera — Cyperus species",
    "durālabhā": "Durālabhā — Fagonia cretica / Alhagi pseudalhagi",
    "kulattha": "Kulattha — horse gram (Macrotyloma uniflorum)",
    "ṣaṣṭika": "Ṣaṣṭika — a type of rice that matures in 60 days",
    "śālayo": "Śāli — rice (nom. pl.) [sandhi form]",
    "pālanikā": "Pālanikā — a medicinal preparation",
    "pālanikayā": "pālanikayā — with pālanikā (instrumental)",

    # === CONCEPTS ===
    "mārgān": "mārgān — channels / paths (accusative pl.)",
    "mārga": "Mārga — channel / path / route",
    "gālān": "gālān — throat parts (accusative pl.)",
    "gaṇa": "Gaṇa — group / class (of herbs)",
    "gaṇaḥ": "Gaṇaḥ — group / class",
    "kṛtā": "kṛta — done / made / prepared (fem.)",
    "kṛtām": "kṛtām — done / made (fem. acc.)",
    "vāṭīkṛtā": "vāṭīkṛtā — made into vaṭī (tablet form)",
    "sruto": "sruta — filtered / strained [sandhi form]",
    "saṃyutā": "saṃyuta — combined / mixed (fem.)",
    "niṣpīḍita": "niṣpīḍita — squeezed out / expressed",
    "niṣpīḍito": "niṣpīḍita — squeezed out [sandhi form]",
    "viyojita": "viyojita — separated / freed from",
    "viyojitam": "viyojitam — separated",
    "pāvaka": "Pāvaka — fire (= agni)",
    "pāvakaḥ": "Pāvakaḥ — fire",
    "tejo": "tejas — fire / radiance [sandhi form: s→o before voiced]",
    "paṅka": "paṅka — mud / slush",
    "paṅkaṃ": "paṅkaṃ — mud",
    "pāṃsu": "pāṃsu — dust / soil",
    "pāṃsuṣu": "pāṃsuṣu — in dust/soil (locative pl.)",
    "paṭūn": "paṭu — sharp / pungent (accusative pl.)",
    "kanīyaḥ": "kanīyas — smaller / lesser (comparative)",
    "śucau": "śuci — pure / clean [locative]",
    "balinaḥ-gen": "balinaḥ — of the strong one (gen.)",
    "kriyākrama": "Kriyākrama — sequence of procedures / treatment protocol",
    "kriyākramaḥ": "Kriyākramaḥ — sequence of procedures",
    "yojyamāmolbaṇe": "yojya+āma+ulbaṇe — to be applied when āma is excessive",
    "va-particle": "va — or (variant of vā)",


    # === FINAL 7 — completing 100-śloka coverage ===
    "yat": "yat — which / what (neuter relative pronoun)",
    "yaḥ": "yaḥ — who / which (masc. relative pronoun)",
    "paraṃ": "param — supreme / ultimate / afterwards",
    "prayojyaḥ": "prayojyaḥ — should be applied / administered (masc. nom.)",
    "sakṣaudgaḥ": "sakṣaudra — with honey [textual variant]",
    "balinaḥ": "balinaḥ — of the strong / powerful (gen. sg.)",


    # ===============================================================
    # TREATMENT PROCEDURES / KRIYĀ (systematic gap — Charaka Ch. 3-5)
    # ===============================================================
    "ālepa": "Ālepa — paste application / anointing",
    "ālepam": "Ālepam — paste application",
    "lepanam": "Lepanam — application of paste",
    "seka": "Seka — pouring / irrigation / sprinkling (treatment)",
    "sekam": "Sekam — pouring",
    "pariseka": "Pariseka — sprinkling / irrigation (external therapy)",
    "parisekam": "Parisekam — sprinkling therapy",
    "avagāha": "Avagāha — immersion bath",
    "avagāham": "Avagāham — immersion bath",
    "dhārā": "Dhārā — continuous stream pouring",
    "śirodhārā": "Śirodhārā — pouring on the head",
    "śirobasti": "Śirobasti — oil retention on head",
    "kavala": "Kavala — mouth gargle",
    "añjana": "Añjana — collyrium / eye application",
    "pradeha": "Pradeha — thick paste application",
    "pralepa": "Pralepa — thin paste application",
    "upanāha": "Upanāha — warm poultice",
    "upanāham": "Upanāham — warm poultice",
    "picu": "Picu — cotton swab / tampon (medicated)",
    "pichu": "Pichu — cotton swab / tampon",
    "bandhana": "Bandhana — bandaging",
    "ālambana": "Ālambana — support / holding",

    # === DIAGNOSTIC / UPAŚAYA TERMS ===
    "saṃsparśa": "Saṃsparśa — contact / touch (therapeutic contact)",
    "saṃsparśān": "Saṃsparśān — contacts / touches (acc. pl.)",
    "sparśana-therapy": "Sparśana — contact therapy / touch therapy",

    # === PREPARATION / FORMULATION TERMS ===
    "kalpita": "kalpita — prepared / formulated / arranged",
    "kalpitān": "kalpitān — prepared (acc. pl.)",
    "kalpitam": "kalpitam — prepared",
    "kalpitaḥ": "kalpitaḥ — prepared",
    "kalpanā-form": "Kalpanā — pharmaceutical formulation / preparation method",
    "sādhitam-prep": "sādhita — prepared / processed (past participle)",

    # === ĀŚRITA / LOCATION TERMS ===
    "āśrita": "āśrita — situated in / localized in / dependent on",
    "āśrite": "āśrita — situated in [locative]",
    "āśritam": "āśritam — situated in",
    "āśritaḥ": "āśritaḥ — situated in",
    "āśraya": "Āśraya — seat / substratum / location",
    "āśrayam": "Āśrayam — seat / location",
    "sthānagatam": "sthānagata — localized (gone to a location)",

    # === ĀDI / PRABHṚTI (etc. terms) ===
    "ādīn": "ādīn — etc. / beginning with (acc. pl. of ādi)",
    "ādīni": "ādīni — etc. (neut. pl.)",
    "ādyaḥ": "ādyaḥ — first / primary",
    "prabhṛti": "prabhṛti — beginning from / starting with",
    "ityādi": "ityādi — and so on / etcetera",
    "ityādīni": "ityādīni — and so on (neut. pl.)",

    # === SANDHI-FUSED FORMS (a+u→o at compound start) ===
    "yatho": "yathā — according to [sandhi: ā+u→o]",
    "tatho": "tathā — so / thus [sandhi: ā+u→o]",

    # === TVK / SKIN-RELATED ===
    "tvag": "Tvak — skin [sandhi form before voiced consonant: k→g]",
    "tvagāśrite": "tvak+āśrita — localized in skin [tvak→tvag before ā]",
    "tvacā": "Tvacā — with/by skin (instrumental)",
    "tvaci": "Tvaci — in/on the skin (locative)",

    # === REMAINING FREQUENT CLINICAL TERMS ===
    "āvṛta-cond": "āvṛta — obstructed / covered / enveloped (doṣa condition)",
    "āvṛte": "āvṛta — obstructed [locative]",
    "āvṛtam": "āvṛtam — obstructed",
    "anulomana": "Anulomana — normalizing direction of vāta flow",
    "anulomanam": "Anulomanam — normalizing vāta flow",
    "grāhiṇī": "Grāhiṇī — absorbent (fem.)",
    "stambhanīya": "Stambhanīya — checking / arresting",
    "śoṣaṇīya": "Śoṣaṇīya — drying / desiccating",
    "chedanīya": "Chedanīya — incising / cutting / clearing",
    "bhedanīya": "Bhedanīya — breaking / splitting (therapy type)",
    "lekhana": "Lekhana — scraping / reducing (therapy)",
    "lekhanam": "Lekhanam — scraping",
    "āpyāyana": "Āpyāyana — nourishment / filling",
    "prīṇana": "Prīṇana — satiating / pleasing",
    "tarpana-therapy": "Tarpaṇa — satiating / nourishing (eye therapy)",
    "pāṭana": "Pāṭana — splitting / incising",

    # === COMMON CHARAKA COMPOUND-INTERNAL TERMS ===
    "upacāra": "Upacāra — treatment / therapeutic measure",
    "upacāram": "Upacāram — treatment",
    "upakāraka": "Upakāraka — beneficial / helpful",
    "upakāra": "Upakāra — benefit / assistance",
    "anugraha": "Anugraha — favor / benefit / support",
    "nigraha": "Nigraha — restraint / control",
    "saṃgraha-action": "Saṃgraha — holding / compacting / astringent action",
    "viśrāma": "Viśrāma — rest / relaxation",
    "viśrānti": "Viśrānti — rest",
    "avabodha": "Avabodha — awakening / understanding",
    "prabodhana": "Prabodhana — awakening / bringing to consciousness",


    # ===============================================================
    # VOWEL-ABSORBED COMPOUND FORMS (initial u/a eaten by sandhi)
    # ===============================================================
    # When a+u→o sandhi happens at a compound boundary:
    #   śīta+uṣṇa → śītoṣṇa → after DP matches 'śīto'→śīta, 
    #   remainder is 'ṣṇa' — which needs to map back to 'uṣṇa'
    # Same pattern as the ruci→aruci fix that worked earlier.

    # u-absorbed forms (initial u eaten by preceding a+u→o)
    "ṣṇa": "Uṣṇa — hot [initial u absorbed by a+u→o sandhi]",
    "ṣṇam": "Uṣṇa — hot [initial u absorbed]",
    "ṣṇe": "Uṣṇa — hot [locative, initial u absorbed]",
    "paśaya": "Upaśaya — diagnostic trial [initial u absorbed by sandhi]",
    "paśaye": "Upaśaya — diagnostic trial [locative, initial u absorbed]",
    "dara": "Udara — abdomen [initial u absorbed by sandhi]",
    "dare": "Udara — abdomen [locative, initial u absorbed]",
    "daka": "Udaka — water [initial u absorbed by sandhi]",
    "ttara": "Uttara — subsequent / upper [initial u absorbed]",
    "tpatti": "Utpatti — origin / production [initial u absorbed]",
    "tthita": "Utthita — arisen [initial u absorbed]",
    "tthite": "Utthita — arisen [locative, initial u absorbed]",
    "śīra": "Uśīra — vetiver root [initial u absorbed by sandhi]",

    # ā-absorbed forms (initial ā eaten by preceding a+ā→ā sandhi)
    "lepa-absorbed": "Ālepa — paste application [initial ā absorbed by compound sandhi]",
    "dīn": "ādīn — etc. (acc. pl.) [initial ā absorbed by sandhi]",
    "dīni": "ādīni — etc. (neut. pl.) [initial ā absorbed]",
    "śrite": "Āśrita — localized in [initial ā absorbed by sandhi]",
    "vṛta": "Āvṛta — covered / obstructed [initial ā absorbed]",
...
class CharakaAnalyzer:
    ...
    def _load_all(self) -> None:
        ...
        # Load Monier-Williams Sanskrit-English Dictionary (185K+ entries)
        # This is the PRIMARY fallback for any word not in our curated SUPPLEMENT.
        import json
        mw_path = self.models_dir / 'mw_dict.json'
        self.mw_index: dict[str, str] = {}
        if mw_path.exists():
            with open(mw_path, 'r', encoding='utf-8') as f:
                self.mw_index = json.load(f)

        # Load WHO Ayurveda Terminology (1,500+ clinical terms)
    ...
    def lookup_iast(self, w: str, allow_particles: bool = True) -> dict | None:
        ...
        if w in SUPPLEMENT:
            return {'english': SUPPLEMENT[w], 'iast': w,
                    'source': 'curated', 'matched_form': w}
        if w in self.mw_index:
            return {'english': self.mw_index[w], 'iast': w,
                    'source': 'MW', 'matched_form': w}
        ...
        for ending, repl, min_len in INFLECTIONS:
            if w.endswith(ending) and len(w) > len(ending):
                ...
                if cand in self.mw_index:
                    return {'english': self.mw_index[cand], 'iast': cand,
                            'source': 'MW', 'matched_form': cand,
                            'matched_via': f'-{ending}'}
        ...
        for end in range(min_len, n + 1):
            ...
            for start in range(max(0, end - 25), end - min_len + 1):
                ...
                if info is None:
                    continue
                length = end - start
                # Base score: length^1.5 (longer matches preferred)
                match_score = length ** 1.5
                # Source bonus: curated entries get +3 bonus to beat MW noise
